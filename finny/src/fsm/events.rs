use crate::{lib::*, FsmBackend, FsmEventQueueSender};
...
impl<E, T> Debug for FsmEvent<E, T>
where
    E: Debug,
    T: Debug,
{
...
impl<E, T> AsRef<str> for FsmEvent<E, T>
where
    E: AsRef<str>,
{
    fn as_ref(&self) -> &str {
...
impl<E, T> FsmEvent<E, T> {
    pub fn to_sub_fsm<FSub>(
        self,
    ) -> FsmEvent<<FSub as FsmBackend>::Events, <FSub as FsmBackend>::Timers>
    where
        FSub: FsmBackend,
        ...
        <FSub as FsmBackend>::Timers: From<E>,
    {
        match self {
            ...
            FsmEvent::Timer(t) => FsmEvent::Timer(t.into()),
            FsmEvent::Event(ev) => FsmEvent::Timer(ev.into()),
        }
    }
}
...
pub struct EventContext<'a, TFsm, Q>
where
    TFsm: FsmBackend,
...
impl<'a, TFsm, Q> Deref for EventContext<'a, TFsm, Q>
where
    TFsm: FsmBackend,
    Q: FsmEventQueueSender<TFsm>,
{
